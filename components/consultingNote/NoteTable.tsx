  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      <div className="flex justify-end">
        <button className="bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded-md text-white w-1/3">
          노트 만들기
        </button>
      </div>
      <div className="flex flex-col space-y-2 bg-blue-100 px-4 py-5 rounded-lg">
        ...
        <div className="flex items-center space-x-2 ml-2 text-sm">
          ...
          <span>무료버전 노트는 계속 업데이트가 가능합니다.</span>
        </div>
        <div className="flex items-center space-x-2 ml-2 text-sm">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span>삭제는 각 노트의 세부페이지에서 가능합니다.</span>
        </div>
        <div className="flex items-center space-x-2 ml-2 text-sm">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span>노트는 본인외에는 확인할 수 없습니다.</span>
        </div>
      </div>
    </div>
  );
