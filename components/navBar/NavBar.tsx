      ...
      <nav className="border-t bottom-0 py-5 flex justify-around items-center w-full fixed z-20 bg-white xl:hidden">
        ...
        <Link href="/consultingNote" className="flex flex-col items-center">
          <svg
            ...
            strokeWidth="1.5"
            stroke="currentColor"
            className={cn("w-6 h-6", pathname.includes("/consultingNote") ? "text-blue-500" : "")}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <span className={cn("text-xs", pathname.includes("/consultingNote") ? "text-blue-500" : "")}>상담노트</span>
        </Link>
        <Link href="/consultingMemo" className="flex flex-col items-center">
          <svg
            ...
            strokeWidth="1.5"
            stroke="currentColor"
            className={cn("w-6 h-6", pathname.includes("/consultingMemo") ? "text-blue-500" : "")}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
